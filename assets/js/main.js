...
(function () {
    ...
    function nightModeTransitionHandler() {
        jQuery('#night-mode-switcher').click(function (e) {
            ...
            // disable in order to avoid cookie usage
            //     saveUserSettings();
        });
    }
    ...
    function userLayoutWidthResizeHandler() {
        ...
        jQuery('.layout-width-resize-trigger')
            .mousedown(function (e) {
                ...
                if (jQuery(this).is('#layout-width-resize-handle_left') || jQuery(this).is('#layout-width-resize-icon')) { resizeHandleDirection = 1; }
                else { resizeHandleDirection = -1; }
        ...
        if (!zhongFramework.isPortable && zhongFramework.tooltipsEnabled === true) {
            ...
            jQuery('.show-tooltip').hover(function () {
                ...
                jQuery(this).mousemove(function (e) {
                    ...
                    if (tooltipPositionX + tooltipElement.width() > jQuery(window).width() - 16) { tooltipPositionX = jQuery(window).width() - tooltipElement.width() - 16; }
                    if (tooltipPositionY + tooltipElement.height() > jQuery(document).height() - 10) { tooltipPositionY = jQuery(document).height() - tooltipElement.height() - 10; }
                    tooltipElement
