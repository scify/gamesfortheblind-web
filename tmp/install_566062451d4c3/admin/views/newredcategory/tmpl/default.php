...
<div class="row-fluid">
    <?php
		if(intval($id) != "0"){
			echo '<h2 class="pub-page-title">'.JText::_("COM_IJOOMLA_SEO_REDIRECT_MANAGER")."&nbsp;:Edit&nbsp;[&nbsp;<small>".$name."</small>&nbsp;]"."</h2>";
		}
		else{
			echo '<h2 class="pub-page-title">'.JText::_("COM_IJOOMLA_SEO_REDIRECT_MANAGER").":&nbsp;New"."</h2>";
		}
	?>
 </div>    
    <div class="control-group">
        ...
        <div class="controls">
            ...
            <span class="editlinktip hasTip" title="<?php echo JText::_("COM_IJOOMLA_SEO_SEO_TOOLTIP_NAME_REDIRECT_CATEG"); ?>" >					
