 ...
 * @since		1.5
 */
class OnepageTableItem extends JTable
{
	/**
	 * Constructor
	 *
	...
	{
		parent::__construct('#__onepage_items', 'id', $_db);
	...
	{     
		...
		{    
			// Get the old row
			$oldrow = JTable::getInstance('Item', 'OnepageTable');
			...
			/*
			$table = JTable::getInstance('Item', 'OnepageTable');
