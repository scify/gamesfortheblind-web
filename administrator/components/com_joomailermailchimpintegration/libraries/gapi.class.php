...
class gapi {
    ...
    */
    public function requestAccountData($start_index=1, $max_results=20)
    {
        ...
        {
            die('GAPI: Failed to request account data. Error: "' . strip_tags($response['body']) . '"');
        }
    }
    ...
    */
    protected function authenticateUser($email, $password)
    {
        ...
        //die('GAPI: Failed to authenticate user. Error: "' . strip_tags($response['body']) . '"');
        }
        */
    ...
    */
    public function __call($name,$parameters)
    {
        ...
        die('No valid root parameter or aggregate metric called "' . $name . '"');
    }
}
...
class gapiAccountEntry
{
    ...
    */
    public function __call($name,$parameters)
    {
        ...
        die('No valid property called "' . $name . '"');
    }
}
...
class gapiReportEntry
{
    ...
    */
    public function __call($name,$parameters)
    {
        ...
        die('No valid metric or dimesion called "' . $name . '"');
    }
}
